...
$query = "INSERT INTO owners(first_name, last_name, phone, email, password) VALUES ('Wesley', 'Kalatai', '5551234', 'wes@wes.com', '1234')";
$query_result = mysqli_query($mysqli_connection, $query);
